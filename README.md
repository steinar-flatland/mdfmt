...
Mdfmt is being developed in C#/.NET 8.0, with plans to upgrade to the next LTS version of C# when it comes out.
...
- The following formatting features are supported:
  ...
  - Maintains in-document links as section numbers change, with support for a couple of different ways of [slugifying](./docs/Glossary.md#slugification) headings.
